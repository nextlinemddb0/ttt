...
SESSION_ID10: { type: String, default: "" },
    ...
    NUM: { type: [String], default: [] },// Fixed spelling: VALUSE -> VALUES
...
async function connectdb() {
    try {
        await mongoose.connect('mongodb://mongo:cXdesiSqtrFNzroRQsnUqTNCzNZhVisP@hayabusa.proxy.rlwy.net:57488');
